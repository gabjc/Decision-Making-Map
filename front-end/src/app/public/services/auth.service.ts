//FULL COPY FROM THOMAS OLIVER
//(https://github.com/ThomasOliver545/angular-material-login-and-register-example/blob/main/src/app/public/services/auth-service/auth.service.ts)
...
import { LoginRequest, LoginResponse, RegisterRequest, RegisterResponse } from 'src/app/public/interfaces';
